...
export const engine = {
    init() {
        ...
        // --- ส่วนสำคัญ: สร้าง MP พร้อม Trait ครบ 4 ด้าน ---
    ...
    forceSwitchParty(mpId) {
        ...
        // Example check: Some traits might be impossible to switch
        if (mp.trait.ideology === "อนุรักษ์นิยม" && state.player.party.ideologies.includes("เสรีนิยม")) {
             // Optional: Make it harder or impossible
        }
...
{
type: uploaded file
fileName: moominoom/democacy/Democacy-678e50529d3057733a5ec4e9212ed7b27539c4a8/js/ui.js
fullContent:
import { state } from './state.js';
import * as Data from './data.js';
