export const state = {
    ...
    world: { nationalBudget: 3400000000000, approval: 50, growth: 2.4, cabinetStability: 80, transparency: 100, stabilityPenalty: 0, growthPenalty: 0, unemployment: 20, crime: 35, health: 60, education: 55, environment: 55, military: 50, protestPressure: 20, institutionalLegitimacy: 70, statMods: { unemployment: [], crime: [], health: [], education: [], environment: [], military: [] } },
    factions: [],
    foreign: [],
    provinces: [],
    parties: [],
