...
export const POLICY_TEMPLATES = [
    ...
    { ministry: "ท่องเที่ยวและกีฬา", name: "ส่งเสริมการท่องเที่ยวเชิงสร้างสรรค์", cost: 1.8e10, delibTime: 35, cooldown: 90, ideology: "โลกาภิวัตน์", goal: "การท่องเที่ยว", target: "ท้องถิ่น", impact: { "ท้องถิ่น": 15, "ทุนข้ามชาติ": 10 }, worldImpact: { unemployment: -4 } },
    { ministry: "ดิจิทัล", name: "โครงสร้างพื้นฐานดิจิทัลแห่งชาติ", cost: 4e10, delibTime: 50, cooldown: 120, ideology: "เทคโนแครต", goal: "เทคโนโลยี", target: "เด็กรุ่นใหม่", impact: { "เด็กรุ่นใหม่": 20, "ข้าราชการ": -10 }, worldImpact: { education: 6, unemployment: -3 } },
    { ministry: "พลังงาน", name: "โครงการพลังงานหมุนเวียนแห่งชาติ", cost: 9e10, delibTime: 70, cooldown: 180, ideology: "หัวก้าวหน้า", goal: "การอนุรักษ์ทรัพยากร", target: "สิ่งแวดล้อม", impact: { "สิ่งแวดล้อม": 25, "นายทุน": -15 }, worldImpact: { environment: 10, unemployment: -2 } },
    { ministry: "พาณิชย์", name: "ควบคุมราคาสินค้าอุปโภคบริโภค", cost: 5e9, delibTime: 30, cooldown: 90, ideology: "ประชานิยม", goal: "คุณภาพชีวิต", target: "ชนชั้นกลาง", impact: { "ชนชั้นกลาง": 15, "นายทุน": -10 }, worldImpact: { crime: -1 } },
    { ministry: "มหาดไทย", name: "กระจายอำนาจสู่องค์กรปกครองส่วนท้องถิ่น", ideology: "การแยกตัว", cost: 2.5e10, delibTime: 60, cooldown: 150, goal: "สิทธิพลเมือง", target: "ท้องถิ่น", impact: { "ท้องถิ่น": 25, "ข้าราชการ": -15 }, worldImpact: { crime: -2 } },
    { ministry: "ยุติธรรม", name: "ปฏิรูปกระบวนการยุติธรรมให้โปร่งใส", cost: 1.5e10, delibTime: 55, cooldown: 130, ideology: "สิทธิมนุษยชน", goal: "ความยุติธรรม", target: "สื่อและปัญญาชน", impact: { "สื่อและปัญญาชน": 20, "ข้าราชการ": -10 }, worldImpact: { crime: -6 } },
    { ministry: "แรงงาน", name: "ปรับขึ้นค่าแรงขั้นต่ำทั่วประเทศ", cost: 0, delibTime: 45, cooldown: 120, ideology: "สังคมนิยม", goal: "สวัสดิการแรงงาน", target: "แรงงาน", impact: { "แรงงาน": 20, "นายทุน": -20 }, worldImpact: { unemployment: 3, crime: -2 } },
