...
export const THAI_NAMES = ["เกรียงไกร", "วิลาศ", "ธนา", "ศิริกัญญา", "สมชาย", "ประวิทย์", "ทักษิณ", "อนุทิน", "พิธา", "จุรินทร์", "ธรรมนัส", "สุดารัตน์", "วราวุธ", "กิตติภพ", "อารีลักษณ์", "ชูวิทย์", "ชวน", "รังสิมันต์", "ปารีณา", "เศรษฐา", "ไพบูลย์", "ปิยบุตร", "นิรันดร์", "ดนัย", "ชัยวุฒิ", "วรากร", "สนธิญาณ", "มงคลกิตติ์", "พรรณิการ์", "ทวี"];
export const THAI_SURNAMES = ["จิตรภักดี", "เลิศอนันต์", "พาณิชย์ศิริ", "รุ่งเรืองไกร", "คงมั่งคั่ง", "วงษ์สุวรรณ", "ชินวัตร", "จูรีกรณ์", "เหล่าพงศ์ศิลป์", "ตระกูลสวัสดิ์", "ภักดีศรีไทย", "กรรณสูตร", "วานิชกุล", "ศิลปอาชา", "เทวกุล", "รัตนเสถียร", "โชติวิทย์", "มานะกร", "วิจิตรโชติ", "ไทยยืนยง"];
